...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% USER INPUT
% Make sure to provide inputs needed in "xtal_cluster.m"

Directory = 'D:\\Research\\scripts\\TriBeam_GND\\'; % Where to save the data
ID = 'TaAMSpalled_mini_'; % Name to give the saved data
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% To only look at the first point
first_only = false;
if(first_only)
