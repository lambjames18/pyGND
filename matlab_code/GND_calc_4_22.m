...
% Name output files
%ID = 'LOCAL_parallel_test2_Ti7_1pct_r5';
...
zOffset = microTEMP(limit1,1)+2;
featIDsTEMP = featIDs(:,:,1:zOffset);
GAOTEMP = GAO(:,:,:,:,1:zOffset);
%
% %%% ---------------------------------------------------------------------
...
zOffset1 = microTEMP(limit1,1)-2;
zOffset2 = microTEMP(limit2,1)+2;
...
zOffset1 = microTEMP(limit2,1)-2;
zOffset2 = microTEMP(limit3,1)+2;
featIDsTEMP = featIDs(:,:,zOffset1:zOffset2);
GAOTEMP = GAO(:,:,:,:,zOffset1:zOffset2);
% %%% ---------------------------------------------------------------------
...
zOffset1 = microTEMP(limit3,1)-2;
zOffset2 = microTEMP(limit4,1)+2;
featIDsTEMP = featIDs(:,:,zOffset1:zOffset2);
GAOTEMP = GAO(:,:,:,:,zOffset1:zOffset2);
% %%% ---------------------------------------------------------------------
...
zOffset1 = microTEMP(limit4,1)-2;
zOffset2 = microTEMP(limit5,1)+2;
featIDsTEMP = featIDs(:,:,zOffset1:zOffset2);
GAOTEMP = GAO(:,:,:,:,zOffset1:zOffset2);
% %%% ---------------------------------------------------------------------
...
zOffset1 = microTEMP(limit5,1)-2;
zOffset2 = microTEMP(limit6,1)+2;
featIDsTEMP = featIDs(:,:,zOffset1:zOffset2);
GAOTEMP = GAO(:,:,:,:,zOffset1:zOffset2);
% %%% ---------------------------------------------------------------------
...
zOffset1 = microTEMP(limit6,1)-2;
zOffset2 = microTEMP(limit7,1)+2;
featIDsTEMP = featIDs(:,:,zOffset1:zOffset2);
GAOTEMP = GAO(:,:,:,:,zOffset1:zOffset2);
% %%% ---------------------------------------------------------------------
...
zOffset1 = microTEMP(limit7,1)-2;
zOffset2 = microTEMP(indexmax,1);
featIDsTEMP = featIDs(:,:,zOffset1:zOffset2);
GAOTEMP = GAO(:,:,:,:,zOffset1:zOffset2);
% %%% ---------------------------------------------------------------------
